...
1. Download the app from [release](https://github.com/hotwax/order-routing-rules/releases) page and extract it.
...
2. Clone app using the command: `git clone https://github.com/hotwax/order-routing-rules.git <repository-name>`
