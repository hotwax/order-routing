// src/util/draftUtils.ts
// Pure draft operation utilities — manifest building, validation, apply, formatting.
// No network calls. Moved from DraftAssistantService.ts.
...
export function normalizeConversationHistory(history: DraftConversationMessage[]): DraftConversationMessage[] {
  return history
    .map((message) => ({
      role: message.role,
