...
- **Preferred**: Use Ionic's built-in typography classes (e.g., `ion-text-capitalize`, `ion-text-center`) and standard HTML headings (`h1`, `h2`, etc.) which are already styled by Ionic.
