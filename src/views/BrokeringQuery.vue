    ...
    <ion-content>
      <main>
        <section id="order-filters" class="menu ion-padding-top">
          <ion-item lines="none">
            <ion-label>
              <h1 v-show="!isRouteNameUpdating || testRoutingInfo.isRoutingTestEnabled">{{ currentRouting.routingName }}</h1>
          ...
          <ion-button v-if="!testRoutingInfo.isRoutingTestEnabled" class="ion-margin-start" color="medium" fill="outline" size="small" @click="isRouteNameUpdating ? updateRouteName() : editRouteName()">
          ...
          <ion-item :disabled="testRoutingInfo.isRoutingTestEnabled">
          ...
          <ion-item-group>
            <ion-item-divider color="light">
              ...
              <ion-button :disabled="testRoutingInfo.isRoutingTestEnabled" v-if="orderRoutingFilterOptions && Object.keys(orderRoutingFilterOptions).length" slot="end" fill="clear" @click="addOrderRouteFilterOptions('ORD_FILTER_PRM_TYPE', 'ENTCT_FILTER', 'Filters')">
            ...
            <p class="empty-state" v-if="!orderRoutingFilterOptions || !Object.keys(orderRoutingFilterOptions).length">
              ...
              <ion-button :disabled="testRoutingInfo.isRoutingTestEnabled" fill="clear" @click="addOrderRouteFilterOptions('ORD_FILTER_PRM_TYPE', 'ENTCT_FILTER', 'Filters')">
            ...
            <ion-item :disabled="testRoutingInfo.isRoutingTestEnabled" v-if="getFilterValue(orderRoutingFilterOptions, ruleEnums, 'QUEUE')">
            ...
            <ion-item :disabled="testRoutingInfo.isRoutingTestEnabled" v-if="getFilterValue(orderRoutingFilterOptions, ruleEnums, 'QUEUE_EXCLUDED')">
            ...
            <ion-item :disabled="testRoutingInfo.isRoutingTestEnabled" v-if="getFilterValue(orderRoutingFilterOptions, ruleEnums, 'SHIPPING_METHOD')">
            ...
            <ion-item :disabled="testRoutingInfo.isRoutingTestEnabled" v-if="getFilterValue(orderRoutingFilterOptions, ruleEnums, 'SHIPPING_METHOD_EXCLUDED')">
            ...
            <ion-item :disabled="testRoutingInfo.isRoutingTestEnabled" v-if="getFilterValue(orderRoutingFilterOptions, ruleEnums, 'PRIORITY')">
            ...
            <ion-item :disabled="testRoutingInfo.isRoutingTestEnabled" v-if="getFilterValue(orderRoutingFilterOptions, ruleEnums, 'PRIORITY_EXCLUDED')">
            ...
            <ion-item :disabled="testRoutingInfo.isRoutingTestEnabled" v-if="getFilterValue(orderRoutingFilterOptions, ruleEnums, 'PROMISE_DATE')">
            ...
            <ion-item :disabled="testRoutingInfo.isRoutingTestEnabled" v-if="getFilterValue(orderRoutingFilterOptions, ruleEnums, 'PROMISE_DATE_EXCLUDED')">
            ...
            <ion-item :disabled="testRoutingInfo.isRoutingTestEnabled" v-if="getFilterValue(orderRoutingFilterOptions, ruleEnums, 'SALES_CHANNEL')">
            ...
            <ion-item :disabled="testRoutingInfo.isRoutingTestEnabled" v-if="getFilterValue(orderRoutingFilterOptions, ruleEnums, 'SALES_CHANNEL_EXCLUDED')">
            ...
            <ion-item :disabled="testRoutingInfo.isRoutingTestEnabled" v-if="getFilterValue(orderRoutingFilterOptions, ruleEnums, 'ORIGIN_FACILITY_GROUP')">
            ...
            <ion-item :disabled="testRoutingInfo.isRoutingTestEnabled" v-if="getFilterValue(orderRoutingFilterOptions, ruleEnums, 'ORIGIN_FACILITY_GROUP_EXCLUDED')">
          ...
          <ion-item-group>
            <ion-item-divider color="light">
              ...
              <ion-button :disabled="testRoutingInfo.isRoutingTestEnabled" v-if="orderRoutingSortOptions && Object.keys(orderRoutingSortOptions).length" slot="end" fill="clear" @click="addOrderRouteFilterOptions('ORD_SORT_PARAM_TYPE', 'ENTCT_SORT_BY', 'Sort')">
                <ion-icon slot="icon-only" :icon="optionsOutline"/>
              </ion-button>
            </ion-item-divider>
            ...
            <p class="empty-state" v-if="!orderRoutingSortOptions || !Object.keys(orderRoutingSortOptions).length">
              ...
              <ion-button :disabled="testRoutingInfo.isRoutingTestEnabled" fill="clear" @click="addOrderRouteFilterOptions('ORD_SORT_PARAM_TYPE', 'ENTCT_SORT_BY', 'Sort')">
                {{ translate("Add sorting") }}
                <ion-icon slot="end" :icon="optionsOutline"/>
              </ion-button>
            </p>
            <ion-reorder-group @ionItemReorder="doRouteSortReorder($event)" :disabled="testRoutingInfo.isRoutingTestEnabled">
              <ion-item :disabled="testRoutingInfo.isRoutingTestEnabled" v-for="(sort, code) in orderRoutingSortOptions" :key="code">
        ...
        <section v-if="inventoryRules.length" id="inventory-rules">
          <section id="inventory-sequence" class="menu">
            <ion-list>
              <ion-reorder-group @ionItemReorder="doReorder($event)" :disabled="testRoutingInfo.isRoutingTestEnabled">
                <ion-item class="rule-item" lines="full" v-for="rule in rulesForReorder" :key="rule.routingRuleId && rulesForReorder.length" :color="rule.routingRuleId === selectedRoutingRule?.routingRuleId ? 'light' : ''" @click="!testRoutingInfo.isRoutingTestEnabled && fetchRuleInformation(rule.routingRuleId)" button :class="{ 'selected-rule': testRoutingInfo.selectedRuleId === rule.routingRuleId }">
                  <ion-label>
                    <h2>{{ rule.ruleName }}</h2>
            ...
            <ion-button v-if="!testRoutingInfo.isRoutingTestEnabled" fill="outline" @click="addInventoryRule">
          ...
          <BrokeringRouteTest v-if="testRoutingInfo.isRoutingTestEnabled" :orderRoutingId="orderRoutingId" :routingGroupId="currentRoutingGroup.routingGroupId" :orderRoutingFilterOptions="orderRoutingFilterOptions" isRoutingTestEnabled/>
        </section>
...
async function exitTestMode() {
  ...
  await store.dispatch("orderRouting/updateRoutingTestInfo", [
    ...
    { key: "isRoutingTestEnabled", value: false }
  ])
  return;
}
